...
if (
  ...
  (/sermon(\.html)?$/.test(window.location.pathname))
) {
...
if (
  ...
  (/notifications(\.html)?$/.test(window.location.pathname))
) {
...
if (
  ...
  (/contacts(\.html)?$/.test(window.location.pathname))
) {
...
if (
  ...
  (/donation(\.html)?$/.test(window.location.pathname))
) {
