document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      if (closeBtn && modal && form && successBox) {
      ...
      if (form && modal && successBox) {
        form.addEventListener("submit", async function (e) {
          e.preventDefault();
          const messageEl = document.getElementById("testimony-message");
          ...
          if (message && member) {
            ...
            try {
              await fetch('https://bible-outdoor-backend.onrender.com/api/testimonies', {
                method: 'POST',
    ...
    function renderGallery() {
      ...
      if (!filterTypeEl || !filterYearEl || !container) return;
    ...
    document.addEventListener('DOMContentLoaded', function () {
      const filterTypeEl = document.getElementById('filter-type');
      const filterYearEl = document.getElementById('filter-year');
      if (filterTypeEl) filterTypeEl.onchange = renderGallery;
      if (filterYearEl) filterYearEl.onchange = renderGallery;
      if (filterTypeEl && filterYearEl && document.getElementById('galleryGrid')) renderGallery();
    });
